...
void TRint_gr::Run(Bool_t retrn)
{
...
void TRint_gr::PrintLogo(Bool_t lite)
{
    if (!lite) {
...
const char *TRint_gr::SetPrompt(const char *newPrompt)
{
...
Bool_t TRint_gr::HandleTermInput()
{
...
void TRint_gr::HandleException(Int_t sig)
{
...
void TRint_gr::Terminate(Int_t status)
{
    Getlinem(kCleanUp, 0);
...
void TRint_gr::SetEchoMode(Bool_t mode)
{
...
Long_t TRint_gr::ProcessRemote(const char *line, Int_t *)
{
...
Long_t  TRint_gr::ProcessLineNr(const char* filestem, const char *line, Int_t *error /*= 0*/)
...
Int_t TRint_gr::TabCompletionHook(char *buf, int *pLoc, std::ostream& out)
{
    if (gTabCom)
